...
export class VpnPortCharacteristic
{
	/**
	 * Bleno instance
	 * @type any
	...
	/**
	 * Create a new instance of VpnPortCharacteristic
	 */
	...
	public onReadRequest(offset: number, callback: (result: number, data: Buffer) => void) 
	{
		...
		const value = nodeManager.getConfig().vpn_port.toString();
