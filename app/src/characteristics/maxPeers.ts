...
export class MaxPeersCharacteristic
{
	/**
	 * Bleno instance
	 * @type any
	...
	/**
	 * Create a new instance of MaxPeersCharacteristic
	 */
	...
	public onReadRequest(offset: number, callback: (result: number, data: Buffer) => void)
	{
		...
		const value = nodeManager.getConfig().max_peers.toString();
